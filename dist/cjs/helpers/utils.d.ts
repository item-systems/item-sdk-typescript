...
import { ContractInvocation, InvokeResult, Neo3Invoker, Neo3Parser, RpcResponseStackItem } from '@cityofzion/neon-dappkit-types';
export declare class Utils {
    ...
    static testInvokerRaw(invoker: Neo3Invoker, invocations: ContractInvocation[]): Promise<InvokeResult<RpcResponseStackItem>>;
