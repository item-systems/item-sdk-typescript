...
class ItemAPI {
    ...
    static getAssetItemJSON(scriptHash, params) {
        return {
            ...
            args: [{ type: 'ByteArray', value: neon_core_1.u.hex2base64(params.assetPubKey) }],
        };
    }
    ...
    static setItemProperties(scriptHash, params) {
        const properties = Object.keys(params.properties).map(key => {
            return neon_core_1.sc.ContractParam.array(neon_core_1.sc.ContractParam.string(key), neon_core_1.sc.ContractParam.any(neon_core_1.u.str2hexstring(params.properties[key]))).toJson();
        });
        return {
            scriptHash,
